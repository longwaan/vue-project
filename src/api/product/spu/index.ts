...
import type { HasSpuResponseData, AllTradeMark, SpuHasImg, SaleAllResponseData, HasSaleAttrResponseData, SpuData, SkuData, SkuInfoData } from "./type";
enum API {
    //获取已有的SPU的数据
...
export const reqSpuHasSaleAttr = (spuId: number) => request.get<any, SaleAllResponseData>(API.SPUHASSALEATTR_URL + spuId)

//获取全部的销售属性
export const reqAllSaleAttr = () => request.get<any, HasSaleAttrResponseData>(API.ALLSALEATTR_URL);

//添加一个新的SPU
//更新已有的SPU//data：即为新增的SPU|或者已有的SPU对象
